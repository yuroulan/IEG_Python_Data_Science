...
# 1
'''
MatPlotLib / Generate Line Plot

Write a Python Program to read in data from a csv file, load a Data Frame and  generate a Line Plot.

Generate a Line Plot with Team Name on the X-axis and Total Medals on the Y-axis. Save the plot in a file named “plot1.png”
...
plt.plot(teams, totMeds, linestyle='--', color='blue', linewidth=3 )

plt.xlabel = ("Team Name")
plt.ylable = ("Total Number of Medals")
